...
export default async function Home() {
  ...
  return (
      <div className="w-full flex flex-col h-full items-center lg:px-32 lg:py-8">
        <ClientNavbar name={userProfile?.name || ''} />
        <div className="flex flex-col flex-1 lg:gap-16 gap-8 p-8 lg:p-0 justify-center items-center">
          <div className="text-center">
            <h1 className="w-full lg:w-xl text-2xl lg:text-4xl/12">The AI Interview platform that strengthens the bridge between you and your future employers.</h1>
          </div>
          <div className="flex flex-col lg:flex-row gap-4 lg:gap-12 items-center justify-center">
            <JoinRoomCode />
            <div className="hidden lg:block border border-accent h-full"></div>
